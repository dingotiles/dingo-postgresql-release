...
(
  ...
  bundle exec exe/dingo-postgresql-clusterdata-backup find-by-name

  # STDOUT is returned to dingo-postgresql-broker
) 2>> $LOG_DIR/broker.backup_provisioned_service.log
